...
function aggregateReports(orders, { storeMap = {} } = {}) {
  ...
  return {
    ...
    bookings: orders.map((o) => ({
      ...
      rentalTotalAmount: o.rentalTotalAmount ?? o.grandtotal ?? 0,
      rentalAdvanceAmount: o.rentalAdvanceAmount ?? 0,
      rentalBalanceAmount: o.rentalBalanceAmount ?? 0,
      grandtotal: o.rentalTotalAmount ?? o.grandtotal ?? 0,
      totalAmount: o.rentalTotalAmount ?? o.grandtotal ?? 0,
