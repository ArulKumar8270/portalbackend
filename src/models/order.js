...
module.exports = (sequelize, DataTypes) => {
  const Order = sequelize.define('orders', {
    ...
    orderAdvancePercent: DataTypes.INTEGER,
    orderAdvanceAmount: DataTypes.INTEGER,
    orderBalanceAmount: DataTypes.INTEGER,
    orderAdvancePaidAt: DataTypes.DATE,
    refundStatus: DataTypes.STRING,
    refundNote: DataTypes.TEXT,
